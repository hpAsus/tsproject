            ...
            <form name="editUserForm" class="editUserForm" method="post" ng-submit="vm.submitForm()" novalidate>
                ...
                <div class="wk-field-item" ng-if="vm.user.role !== vm.adminRole"
                    ...
                    <div class="wk-field-body">
                        <input type="text" id="login" name="login" ng-model="vm.user.email" required="required"
                               ts-email-validator/>
                    </div>
                ...
                <input type="hidden" name="email" ng-model="vm.user.email" ng-if="vm.user.role == vm.adminRole">
                ...
                <div class="wk-field-item"
                    ...
                    <div class="wk-field-body">
                        <input type="text" id="name" name="name" ng-model="vm.user.name" required="required"
                               at-name-validator>
                    </div>
                ...
                <div class="wk-field-item"
                    ...
                    <div class="wk-field-body">
                        <textarea required="required" name="bio" id="bio" ng-model="vm.user.bio"
                                  at-bio-validator></textarea>
                    </div>
